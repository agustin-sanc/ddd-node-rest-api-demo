import {REST_API_SERVER_URI_PREFIX} from "../endpoint-uri-constants";

export const CREATE_USER_REST_API_ENDPOINT_URI: string =
...
export const UPDATE_USER_REST_API_ENDPOINT_URI: string =
  REST_API_SERVER_URI_PREFIX + 'user';
